    ...
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          ...
          <p>En la siguiente tabla encontrará todos los permisos que han solicitado los empleados del departamento de <?php echo e($info_empleados->departamento); ?> del cual es líder. Puedes aprobar o declinar permisos dando click en la columna Estado.</p>
          ...
          <div class="table-responsive">
            <table class="table datatable table-striped table-bordered table-sm table-responsive">
              ...
              <tbody>
                ...
                <tr>
                  <td> <?php echo e($permiso->nombre_empleado); ?> </td>
                  ...
                  <td> <?php echo e($permiso->dias); ?> </td>
                  <td> <?php echo e($permiso->horas); ?> </td>
                  <td> <?php echo e($permiso->minutos); ?> </td>
                  <td class="<?php if($permiso->estado === 'Aprobado'): ?> table-success 
                  ...
                  <td class="text-center">
                    ...
                    <a href="#" class="btn btn-outline-success btn-sm" title="Actuar" data-bs-toggle="modal" data-bs-target="#actuarModal" onclick="setPermisoId('<?php echo e($permiso->id_permiso); ?>', '<?php echo e($permiso->nombre_empleado); ?>', '<?php echo e($permiso->permiso); ?>')">
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backup/public_html/people/resources/views/usuarios/permisos.blade.php ENDPATH**/ ?>