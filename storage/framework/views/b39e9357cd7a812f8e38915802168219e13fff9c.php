...
<section class="section">
            ...
            <div class="card" style="background-color: rgb(252,252,255);">
                <div class="card-body">
                    <div class="reloj" style="display: flex; justify-content: space-around; align-items:center">
                        <h3 class="card-title fs-4"><?php echo e($info_empleados->sede); ?></h3>
                        <img style="width: 90px;; height: 90px;;" src="<?php echo e(asset('assets/img/temporizador.gif')); ?>" alt="roloj">
                    </div>
                    <p class="text-end"><?php echo e(\Carbon\Carbon::now()->format('l, d F Y')); ?></p>
                </div>
                <!-- boton para ponchar -->
                <form method="POST" id="locationForm">
                    ...
                    <div class="d-flex pb-4 justify-content-center">
                        <span class="dropdown-el">
                            ...
                            <input type="radio" name="estado-info" value="<?php echo e($estado->id_estado); ?>" id="sort-<?php echo e($estado->id_estado); ?>" <?php echo e($loop->first ? 'checked' : ''); ?>>
                            <label for="sort-<?php echo e($estado->id_estado); ?>"><?php echo e($estado->estado); ?></label>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php $i=1; ?>
                            <?php $__currentLoopData = $fichaTiempo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ficha): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td scope="row"><?php echo e($ficha->id_pd_info); ?></td>
                                <td style="background-color: <?php echo e($ficha->color); ?>;"><?php echo e($ficha->estado); ?></td>
                                <td><?php echo e(\Carbon\Carbon::parse($ficha->tiempo)->format('h:i A')); ?></td>
                                <?php if($fichaTiempo->isNotEmpty() && $fichaTiempo->last()->id_pd_info == $ficha->id_pd_info && Carbon::parse($ficha->tiempo)->diffInMinutes(Carbon::now()) <= 1): ?>
                                    <td class="">
                                    <a href="<?php echo e(route('fichaje-deshacer',$ficha->id_pd_info)); ?>" class="btn btn-outline-danger btn-sm" title="Eliminar">
    ...
    <div class="modal fade" id="actuarModal" tabindex="-1" aria-labelledby="actuarModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="miFormulario" action="<?php echo e(route('fichaje.correccion')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="modal-body">
                        <label class="form-check-label pb-3" for=""><strong>Ultimo estado registrado:</strong>
                            <p style="color: <?php echo e($ultimoEstado->color ? $ultimoEstado->color : '#000'); ?>; font-weight: bold;">
                                <?php echo e($ultimoEstado->estado); ?>

                            </p>
                            <strong>
                                <p class="mb-0">Fecha:</p>
                            </strong>
                            <p><?php echo e(\Carbon\Carbon::parse($ultimoEstado->tiempo)->format('Y-m-d')); ?></p>
                            <strong>
                                <p class="mb-0">Hora:</p>
                            </strong>
                            <p class="mb-0"><?php echo e(\Carbon\Carbon::parse($ultimoEstado->tiempo)->format('h:i A')); ?></p>
                        </label>
                        <!-- Input hidden para latitud y longitud -->
    ...
    <div class="modal fade" id="modalAusencia" tabindex="-1" aria-labelledby="modalAusenciaLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo e(route('fichaje.ausencia')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <label class="form-check-label pb-3" for=""><strong>Cantidad de dias de ausencia:</strong>
                            <p style="font-weight: bold; color:red;">
                                <?php echo e($intervaloDias - 1); ?>

                            </p>
                            <strong>
                                <p class="mb-0">Fecha Inicio:</p>
                            </strong>
                            <input class="form-control" type="text" id="" name="fecha_inicio" value="<?php echo e(\Carbon\Carbon::parse($ultimoEstado->tiempo)->addDay()->format('Y-m-d')); ?>" readonly>
                            <strong>
                            ...
                            <div class="col-sm-10">
                                <select name="motivo" class="form-select" aria-label="Default select example" required>
                                    ...
                                    <option value="<?php echo e($tipo->permiso); ?>" <?php echo e(old('id_tipo_permiso') == $tipo->id_tipo_permiso ? 'selected' : ''); ?>>
    ...
    <!-- Permisos -->
    <?php if($permisosHoy->isNotEmpty()): ?>
    <?php $__currentLoopData = $permisosHoy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $perHoy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php if($perHoy->regresa==1 && $perHoy->estado=='Aprobado'): ?>
    <div class="row">
        <div class="col-lg-4">
            ...
            <div class="card" style="background-color: rgb(252,252,255);">
                <div class="card-body">
                    <div class="reloj" style="display: flex; justify-content: space-around; align-items:center">
                        <h3 class="card-title fs-4"><?php echo e($perHoy->permiso); ?></h3>
                        <img style="width: 100px;; height: 80px;" src="<?php echo e(asset('assets/img/permiso.png')); ?>" alt="roloj">
                    </div>
                    <p class="text-end"><?php echo e(\Carbon\Carbon::now()->format('l, d F Y')); ?></p>
                </div>
                <!-- boton para ponchar -->
                <form action="<?php echo e(route('fichajePermiso')); ?>" method="POST" id="locationFormPermiso<?php echo e($perHoy->id_permiso); ?>">
                    <?php echo csrf_field(); ?>
                    <!-- <div class="d-flex pb-4 justify-content-center">
                        <span class="dropdown-el">
                    ...
                    <div class="d-flex pb-4 justify-content-center">
                        <span class="dropdown-el">
                            <input type="radio" name="estado-permiso" value="<?php echo e($estadosPermiso=='fin' ? 'inicio' : 'fin'); ?>" id="sort-<?php echo e($estadosPermiso=='fin' ? 'inicio' : 'fin'); ?>" <?php echo e($loop->first ? 'checked' : ''); ?>>
                            <label for="sort-<?php echo e($estadosPermiso=='fin' ? 'inicio' : 'fin'); ?>"><?php echo e($estadosPermiso=='fin' ? 'inicio' : 'fin'); ?></label>
                        </span>
                    </div>
                    ...
                    <!-- Input hidden para latitud y longitud -->
                    <input type="hidden" name="latitudep" id="latitudep<?php echo e($perHoy->id_permiso); ?>">
                    <input type="hidden" name="longitudep" id="longitudep<?php echo e($perHoy->id_permiso); ?>">
                    <input type="hidden" name="id_permiso" value="<?php echo e($perHoy->id_permiso); ?>">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php $i=1; ?>
                            <?php $__currentLoopData = $fichaPermiso; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fichap): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($fichap->id_permiso == $perHoy->id_permiso): ?>
                            <tr>
                                <th scope="row"><?php echo e($i++); ?></th>
                                <td class="table-secondary"><?php echo e($fichap->estado); ?></td>
                                <td><?php echo e(\Carbon\Carbon::parse($fichap->tiempo)->format('h:i A')); ?></td>
                                <?php if($fichaPermiso->isNotEmpty() && $fichaPermiso->last()->id_pd_info_permisos == $fichap->id_pd_info_permisos && Carbon::parse($fichap->tiempo)->diffInMinutes(Carbon::now()) <= 1): ?>
                                <td class="">
                                    <a href="<?php echo e(route('fichaje-deshacer-permiso',$fichap->id_pd_info_permisos)); ?>" class="btn btn-outline-danger btn-sm" title="Editar">
                                        <i class="bi bi-backspace-fill"></i>
                                    </a>
                                    </td>
                                    <?php else: ?> <td></td>
    ...
    function obtenerUbicacionPermiso() {
        if (navigator.geolocation) {
            ...
            navigator.geolocation.getCurrentPosition(function(position) {
                ...
                document.getElementById('latitudep<?php echo e($perHoy->id_permiso); ?>').value = position.coords.latitude;
                document.getElementById('longitudep<?php echo e($perHoy->id_permiso); ?>').value = position.coords.longitude;

                // Ahora, enviamos el formulario con los datos de la ubicación
                document.getElementById('locationFormPermiso<?php echo e($perHoy->id_permiso); ?>').submit();
            }, function(error) {
...
<?php if($intervaloDias > 1 && ($ultimoEstado->tipo_estado == 'out' || $ultimoEstado->tipo_estado == 'ausencia')): ?>
<script>
...
<?php if($ultimoEstado->tipo_estado == 'in'): ?>
<script>
    $(document).ready(function() {
        $('#actuarModal').modal({
            backdrop: 'static',
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        flatpickr("#datetimeAusencia", {
            ...
            time_24hr: false,
            defaultDate: false,
            minDate: "<?php echo e($minFechaAusencia); ?>",
            maxDate: "<?php echo e($maxFechaAusencia); ?>"
        });
    });
</script>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backup/public_html/people/resources/views/usuarios/fichaje.blade.php ENDPATH**/ ?>