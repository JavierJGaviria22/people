          ...
          <div class="card info-card sales-card">
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <h6><?php echo e($info_empleados->vacaciones_disponibles); ?> <?php echo e($info_empleados->formato); ?></h6>
                  <span class="text-primary small pt-1 fw-bold"><?php echo e($info_empleados->vacaciones_acumuladas); ?></span>
          ...
          <div class="card info-card revenue-card">
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <h6><?php echo e($permisos_aprobados); ?></h6>
                  <span class="text-success small pt-1 fw-bold"><?php echo e($permisos > 0 ? round(($permisos_aprobados * 100 / $permisos),1) : 0); ?>%</span> <span
          ...
          <div class="card info-card customers-card">
            ...
            <div class="card-body">
              ...
              <div class="d-flex align-items-center">
                ...
                <div class="ps-3">
                  <h6><?php echo e($permisos_pendientes); ?></h6>
                  <span class="text-danger small pt-1 fw-bold"><?php echo e($permisos > 0 ? round(($permisos_pendientes * 100 / $permisos),1) : 0); ?>%</span> <span
        ...
        <hr>-->
          ...
          <div class="news">
            ...
            <div class="post-item clearfix ml-0">
              ...
              <p style="margin-left: 0px;"><?php echo nl2br(e($noticia->contenido)); ?></p>
            </div>
  ...
  <div class="modal fade" id="modalPassword" tabindex="-1" aria-labelledby="modalPasswordLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="<?php echo e(route('newPass')); ?>" method="post">
          <?php echo csrf_field(); ?>
...
<?php if($pass === '$2a$04$0O0EPbbB338aEhPk9iIIZeJGfvSLn2eDTC4tHENzFIWzucno1Gg0a'): ?>
<script>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/backup/public_html/people/resources/views/usuarios/inicio.blade.php ENDPATH**/ ?>