...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="{{ route('/')}}" class="logo d-flex align-items-center">
                ...
                <span class="d-none d-lg-block">{{$info_empleados->sede;}}</span>
            </a>
            ...
            <ul class="d-flex align-items-center">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
                        ...
                        <li class="notification-item">
                            ...
                            <div>
                                ...
                                <p style="text-align: end; font-weight: bold;">hace {{ $notificacion->hace }} días</p>
                            </div>
                        </li>
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        ...
                        <span class="d-none d-md-block dropdown-toggle ps-2">{{ $usuario->empleado->nombre; }}</span>
                    </a><!-- End Profile Iamge Icon -->

                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        <li class="dropdown-header">
                            <h6>{{ $usuario->empleado->nombre; }} {{ $usuario->empleado->apellido; }}</h6>
                            <span>{{ $usuario->empleado->cargo; }}</span>
                        </li>
                        <li>
                            <hr class="dropdown-divider">
                        </li>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            <div style="width: 100%;">
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() === '/' ? '' : 'collapsed' }}" href="{{ route('/') }}">
                ...
                <!-- End Fichaje Nav -->
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() === 'fichaje' ? '' : 'collapsed' }}" href="{{ route('fichaje') }}">
                ...
                <!-- End calendario Nav -->
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() === 'calendario' ? '' : 'collapsed' }}" href="{{ route('calendario') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() == 'mis-permisos' || Route::currentRouteName() == 'vacaciones' ? '' : 'collapsed' }}" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
                        <i class="bi bi-menu-button-wide"></i><span>Solicitudes</span><i class="bi bi-chevron-down ms-auto"></i>
                    </a>
                    <ul id="components-nav" class="nav-content {{ Route::currentRouteName() === 'mis-permisos' || Route::currentRouteName() === 'vacaciones' ? '' : 'collapse' }} " data-bs-parent="#sidebar-nav">
                        <li>
                            <a class="{{ Route::currentRouteName() === 'mis-permisos' ? 'active' : '' }}" href="{{ route('mis-permisos') }}">
                ...
                @endphp
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() === 'permisos' ? '' : 'collapsed' }}" href="{{route('permisos')}}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() === 'horarios.index' ? '' : 'collapsed' }}" href="{{route('horarios.index')}}">
                        <i class="bi bi-calendar"></i>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Route::currentRouteName() === 'reporte-horas-l' ? '' : 'collapsed' }}" href="{{route('reporte-horas-l')}}">
