                ...
                <div class="card-body ">
                    <form action="{{route('horarios.update', $horario->id_horario)}}" method="POST">
                        ...
                        <div class=" d-flex align-items-baseline justify-content-between mt-3">
                            <h5 class="card-title">Horario para actualizar a <strong> {{$nombre_empleado->nombre}} {{$nombre_empleado->apellido}}</strong></h5>
                                ...
                                <tbody>
                                    @php $i=0; @endphp
                                        <tr>
                                            ...
                                            <td class="text-center"><input value="{{$horario->entrada_h}}" name="entrada{{$i}}" class="form-control hora1" type="time" id="hora" required></td>
                                            <td class="text-center"><input value="{{$horario->salida_h}}" name="salida{{$i}}" class="form-control hora2" type="time" id="hora2" required></td>
                                            <td class="text-center"><input value="{{$horario->tiempo_fuera}}" name="lunch{{$i}}" class="form-control lunch" type="number" id="cantidad" name="cantidad" min="0" step="any" required></td>
                                            <td class="text-center"> <select style="width: auto;" id="sede" name="sede{{$i}}" class="form-select" aria-label="Default select example" required>
                                                    <option value="" {{ $horario->id_sede ? '' : 'selected' }} disabled>Seleccionar</option>
                                            ...
                                            <td class="text-center"><input value="{{$horario->total}}" name="total{{$i}}" class="form-control resultado" id="resultado" required readonly></td>
