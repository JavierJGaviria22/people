...
const data = @json($inconsistencias);
...
function displayTable() {
  ...
  paginatedData.forEach(item => {
    const row = `<tr>
        ...
        <td class="text-center">
          <a href="{{ url('reporte-detalle/') }}/${item.id_empleado}/${item.fecha}/show" class="btn btn-outline-primary btn-sm" title="Editar" target="_blank" rel="noopener noreferrer">
            <i class="bi bi-eye"></i>
          </a>
        </td>
    </tr>`;
