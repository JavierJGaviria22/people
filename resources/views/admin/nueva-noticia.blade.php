...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('noticias.create') }}">Nueva Noticia</a></li>
        </ol>
    </nav>
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('noticias.store')}}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="titulo" name="titulo" class="form-control" value="{{ old('titulo') }}" placeholder="Ej: Nuevo Integrante..." required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea id="contenido" name="contenido" class="form-control" style="height: 100px" placeholder="Ej: Le damos la bienvenida a...">{{ old('contenido') }}</textarea>
                            </div>
                        </div>
