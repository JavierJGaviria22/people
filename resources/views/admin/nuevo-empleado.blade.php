...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('nuevo-empleado') }}">Nuevo Empleado</a></li>
        </ol>
    </nav>
...
<section class="section">
    ...
    @endif
    <form action="{{route('nuevo-empleado')}}" method="POST">
        @csrf
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" id="cedula" name="cedula" class="form-control col-sm-1" value="{{ old('cedula') }}" placeholder="Ej: Cedula..." required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="nombre" name="nombre" class="form-control col-sm-1" value="{{ old('nombre') }}" placeholder="Ej: Marcos..." required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="apellido" name="apellido" class="form-control col-sm-1" value="{{ old('apellido') }}" placeholder="Ej: Fenix..." required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="datetime" name="nacimiento" class="form-control" value="{{ old('nacimiento') }}" placeholder="Ej: 1995-05-16" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="email" id="email" name="email" class="form-control col-sm-1" value="{{ old('email') }}" placeholder="Ej: Corre@gmail.com" required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="datetime2" name="ingreso" class="form-control" value="{{ old('ingreso') }}" placeholder="Ej: {{today()->format('Y-m-d')}}" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="telefono" name="telefono" class="form-control col-sm-1" value="{{ old('telefono') }}" placeholder="Ej: 3216549871" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select id="estado-civil" name="estado-civil" class="form-select" aria-label="Default select example" required>
                                    <option value="" selected disabled>Seleccionar</option>
                                    <option value="Soltero" {{ old('estado-civil') == 'Soltero' ? 'selected' : '' }}>Soltero/a</option>
                                    <option value="Casado" {{ old('estado-civil') == 'Casado' ? 'selected' : '' }}>Casado/a</option>
                                    <option value="Divorciado" {{ old('estado-civil') == 'Divorciado' ? 'selected' : '' }}>Divorciado/a</option>
                                    <option value="Viudo" {{ old('estado-civil') == 'Viudo' ? 'selected' : '' }}>Viudo/a</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="nhijos" name="nhijos" class="form-control col-sm-1" value="{{ old('nhijos') }}" placeholder="Ej: 2" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select id="dpto" name="dpto" class="form-select" aria-label="Default select example" required>
                                    <option value="" {{ old('dpto') ? '' : 'selected' }} disabled>Seleccionar</option>
                                    @foreach($selectDepartamentos as $dpto)
                                    <option value="{{ $dpto->id_departamento }}" {{ old('dpto') == $dpto->id_departamento ? 'selected' : '' }}>
                                        {{ $dpto->nombre }}
                                    </option>
                                    @endforeach
                                </select>
