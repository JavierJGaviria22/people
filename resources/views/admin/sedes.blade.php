        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <p>En la siguiente tabla encontrará todas las Sedes de {{ $info_admins->empresa }}.</p>
                    <div class="mb-3 text-end">
                        <a href="{{route('sedes.create')}}" class="btn btn-primary btn-sm" title="Nuevo">
                    ...
                    <div class="table-responsive">
                        <table class="table datatable table-striped table-bordered table-sm table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> {{$sede->nombre }} </td>
                                    <td> {{$sede->zona_horaria }} </td>
                                    <td class="text-center">
                                        <a href="{{ route('sedes.edit', $sede->id_sede) }}" class="btn btn-outline-primary btn-sm" title="Editar">
                                            <i class="bi bi-pencil"></i></a>
                                    </td>
                                    <td class="text-center">
                                        <a href="{{ route('sedes.show', $sede->id_sede) }}" class="btn btn-outline-danger btn-sm" title="Eliminar"
