...
@section('title', 'SkaPeople - Inconsistencias')
...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('mis-permisos') }}">Nomina</a></li>
            <li class="breadcrumb-item"><a href="{{ route('nuevo-permiso') }}">Corregir Inconsistencias</a></li>
        </ol>
    </nav>
        ...
        <div class="col-lg-10">
            <div class="card">
                <div class="card-body ">
                    ...
                    <form id="fechaForm" action="{{route('nomina.showInconsistencias',['start_date' => 1, 'end_date' => 1])}}" method="GET">

                        <div class="row mb-3">
                            <label for="datetime2" class="col-sm-2 col-form-label">Fecha Inicio</label>
                            <div class="col-sm-10">
                                <input type="text" id="datetime" name="fecha_inicio" class="form-control" value="{{ old('fecha_inicio') }}" placeholder="" required>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="datetime2" name="fecha_fin" class="form-control" value="{{ old('fecha_fin') }}" placeholder="" required>
                            </div>
                        </div>
