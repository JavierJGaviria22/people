                                ...
                                @php $i=0; @endphp
                                    @foreach($horarios as $horario)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center"><input name="entrada{{$i}}" class="form-control hora1" type="time" id="hora" value="{{$horario->entrada_h}}" required disabled></td>
                                            <td class="text-center"><input name="salida{{$i}}" class="form-control hora2" type="time" id="hora2" value="{{$horario->salida_h}}" required></td>
                                            <td class="text-center"><input name="lunch{{$i}}" class="form-control lunch" type="number" id="cantidad" name="cantidad" min="0" step="any" value="{{$horario->tiempo_fuera}}" required></td>
                                            ...
                                            <td class="text-center"><input name="total{{$i}}" class="form-control resultado" id="resultado" value="{{$horario->total}}" required readonly></td>
